...
final class AutoValue_Text_Paragraph extends Text.Paragraph {
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof Text.Paragraph) {
      ...
      return this.textResId == that.textResId()
          ...
          && this.link == that.link()
          && this.urlLink.equals(that.urlLink());
    }
    return false;
  }
  ...
  static final class Builder extends Text.Paragraph.Builder {
    ...
    @Override
    public Text.Paragraph.Builder setUrlLink(String urlLink) {
      if (urlLink == null) {
        throw new NullPointerException("Null urlLink");
      }
      this.urlLink = urlLink;
      return this;
    }
