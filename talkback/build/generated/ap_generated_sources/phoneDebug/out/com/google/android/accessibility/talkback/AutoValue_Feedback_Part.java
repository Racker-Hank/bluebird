...
final class AutoValue_Feedback_Part extends Feedback.Part {
  ...
  private final Feedback.@Nullable UniversalSearch universalSearch;

  private final Feedback.@Nullable ServiceFlag serviceFlag;
  ...
  private AutoValue_Feedback_Part(
      ...
      Feedback.@Nullable UniversalSearch universalSearch,
      Feedback.@Nullable ServiceFlag serviceFlag) {
  ...
  @Override
  public Feedback.@Nullable UniversalSearch universalSearch() {
    return universalSearch;
  }

  @Override
  public Feedback.@Nullable ServiceFlag serviceFlag() {
    return serviceFlag;
  }
  ...
  public boolean equals(@Nullable Object o) {
    ...
    if (o instanceof Feedback.Part) {
      ...
      return this.delayMs == that.delayMs()
          ...
          && (this.universalSearch == null ? that.universalSearch() == null : this.universalSearch.equals(that.universalSearch()))
          && (this.serviceFlag == null ? that.serviceFlag() == null : this.serviceFlag.equals(that.serviceFlag()));
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    h$ *= 1000003;
    h$ ^= (universalSearch == null) ? 0 : universalSearch.hashCode();
    h$ *= 1000003;
    h$ ^= (serviceFlag == null) ? 0 : serviceFlag.hashCode();
    return h$;
  }
  ...
  static final class Builder extends Feedback.Part.Builder {
    ...
    private Feedback.@Nullable UniversalSearch universalSearch;
    private Feedback.@Nullable ServiceFlag serviceFlag;
    Builder() {
    }
    @Override
